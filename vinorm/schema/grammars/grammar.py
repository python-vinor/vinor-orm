...
class SchemaGrammar(Grammar):
    ...
    def compile_rename_column(self, blueprint, command, connection):
        ...
        :type connection: vinorm.connections.Connection
    ...
    def _get_renamed_diff(self, blueprint, command, column, schema):
        ...
        :type column: vinorm.dbal.Column

        :param schema: The schema
        :type schema: vinorm.dbal.SchemaManager

        :rtype: vinorm.dbal.TableDiff
        """
    ...
    def _get_table_with_column_changes(self, blueprint, table):
        ...
        :type table: vinorm.dbal.table.Table

        :rtype: vinorm.dbal.table.Table
        """
        table = table.clone()
    ...
    def _get_column_for_change(self, table, fluent):
        ...
        :rtype: vinorm.dbal.column.Column
        """
    ...
    def platform(self):
        ...
        :rtype: vinorm.dbal.platforms.platform.Platform
        """
