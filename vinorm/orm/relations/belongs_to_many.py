...
class BelongsToMany(Relation):
    ...
    def get_relation_count_query(self, query, parent):
        ...
        :type query: vinorm.orm.Builder
        :type parent: vinorm.orm.Builder

        :rtype: vinorm.orm.Builder
        """
    ...
    def attach(self, id, attributes=None, touch=True):
        ...
        """
        if isinstance(id, vinorm.orm.Model):
            id = id.get_key()
    ...
    def detach(self, ids=None, touch=True):
        ...
        """
        if isinstance(ids, vinorm.orm.model.Model):
            ids = ids.get_key()
