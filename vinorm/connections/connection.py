...
query_logger = logging.getLogger("vinorm.connection.queries")
connection_logger = logging.getLogger("vinorm.connection")


def run(wrapped):
    """
    Special decvinorm encapsulating query method.
    """
...
class Connection(ConnectionInterface):
    ...
    def get_schema_builder(self):
        ...
        :rtype: vinorm.schema.builder.SchemaBuilder
        """
