...
class SchemaGrammar(Grammar):
    ...
    def compile_rename_column(self, blueprint, command, connection):
        ...
        :type connection: vinor.connections.Connection
    ...
    def _get_renamed_diff(self, blueprint, command, column, schema):
        ...
        :type column: vinor.dbal.Column

        :param schema: The schema
        :type schema: vinor.dbal.SchemaManager

        :rtype: vinor.dbal.TableDiff
        """
    ...
    def _get_table_with_column_changes(self, blueprint, table):
        ...
        :type table: vinor.dbal.table.Table

        :rtype: vinor.dbal.table.Table
        """
        table = table.clone()
    ...
    def _get_column_for_change(self, table, fluent):
        ...
        :rtype: vinor.dbal.column.Column
        """
    ...
    def platform(self):
        ...
        :rtype: vinor.dbal.platforms.platform.Platform
        """
