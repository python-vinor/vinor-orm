...
class BelongsToMany(Relation):
    ...
    def get_relation_count_query(self, query, parent):
        ...
        :type query: vinor.orm.Builder
        :type parent: vinor.orm.Builder

        :rtype: vinor.orm.Builder
        """
    ...
    def attach(self, id, attributes=None, touch=True):
        ...
        """
        if isinstance(id, vinor.orm.Model):
            id = id.get_key()
    ...
    def detach(self, ids=None, touch=True):
        ...
        """
        if isinstance(ids, vinor.orm.model.Model):
            ids = ids.get_key()
