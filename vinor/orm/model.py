...
class Model(object):
    ...
    def add_global_scope(cls, scope, implementation=None):
        ...
        :type scope: vinor.orm.scopes.scope.Scope or callable or str
    ...
    def has_global_scope(cls, scope):
        ...
        :param scope: The scope to register
        :type scope: vinor.orm.scopes.scope.Scope or str
        """
    ...
    def has_one(
        ...
        if _wrapped:
            warn(
                ...
                "Use the appropriate decvinor instead.",
    ...
    def get_connection(self):
        ...
        :rtype: vinor.connections.Connection
        """
