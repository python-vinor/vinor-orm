...
class morph_one(relation):
    """
    Morph One relationship decvinor
    """
...
class belongs_to(relation):
    """
    Belongs to relationship decvinor
    """
...
class morph_to(relation):
    """
    Morph To relationship decvinor
    """
...
class has_many(relation):
    """
    Has Many relationship decvinor
    """
...
class has_many_through(relation):
    """
    Has Many Through relationship decvinor
    """
...
class morph_many(relation):
    """
    Morph Many relationship decvinor
    """
...
class belongs_to_many(relation):
    """
    Belongs To Many relationship decvinor
    """
...
class morph_to_many(relation):
    """
    Morph To Many relationship decvinor
    """
...
class morphed_by_many(relation):
    """
    Morphed By Many relationship decvinor
    """
