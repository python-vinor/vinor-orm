...
query_logger = logging.getLogger("vinor.connection.queries")
connection_logger = logging.getLogger("vinor.connection")


def run(wrapped):
    """
    Special decvinor encapsulating query method.
    """
...
class Connection(ConnectionInterface):
    ...
    def get_schema_builder(self):
        ...
        :rtype: vinor.schema.builder.SchemaBuilder
        """
